...
public class DoWhile extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DoWhile.class.getName());
    ...
    public DoWhile() {
        initComponents();
        this.setTitle("MENU DE OPERACIONES");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MENU DE OPERACIONES BASICAS ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DoWhile().setVisible(true));
    }
